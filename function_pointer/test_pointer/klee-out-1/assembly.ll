...
define i32 @main() #0 {
  ...
  %3 = load %struct.foo** %foo_ptr, align 8, !dbg !156
  %4 = bitcast %struct.foo* %3 to i8*, !dbg !156
  call void @klee_make_symbolic(i8* %4, i64 8, i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0)), !dbg !156
  %5 = load %struct.foo** %foo_ptr, align 8, !dbg !157
  %6 = call i32 @bar(%struct.foo* %5), !dbg !157
  ret i32 0, !dbg !158
}
