...
define i32 @main() #0 {
  ...
  store i32 0, i32* %1
  %2 = call noalias i8* @malloc(i64 8) #7, !dbg !155
  %3 = bitcast i8* %2 to %struct.foo*, !dbg !155
  store %struct.foo* %3, %struct.foo** %foo_ptr, align 8, !dbg !155
  %4 = load %struct.foo** %foo_ptr, align 8, !dbg !156
  %5 = bitcast %struct.foo* %4 to i8*, !dbg !156
  call void @klee_make_symbolic(i8* %5, i64 8, i8* getelementptr inbounds ([4 x i8]* @.str, i32 0, i32 0)), !dbg !156
  %6 = load %struct.foo** %foo_ptr, align 8, !dbg !157
  %7 = call i32 @bar(%struct.foo* %6), !dbg !157
  ret i32 %7, !dbg !157
}
...
define i64 @klee_choose(i64 %n) #4 {
  ...
  %1 = bitcast i64* %x to i8*, !dbg !158
  call void @klee_make_symbolic(i8* %1, i64 8, i8* getelementptr inbounds ([12 x i8]* @.str1, i64 0, i64 0)) #8, !dbg !158
  %2 = load i64* %x, align 8, !dbg !159, !tbaa !161
  %3 = icmp ult i64 %2, %n, !dbg !159
  br i1 %3, label %5, label %4, !dbg !159

; <label>:4                                       ; preds = %0
  call void @klee_silent_exit(i32 0) #9, !dbg !165
  unreachable, !dbg !165
...
define void @klee_div_zero_check(i64 %z) #4 {
  %1 = icmp eq i64 %z, 0, !dbg !167
  br i1 %1, label %2, label %3, !dbg !167

; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([22 x i8]* @.str12, i64 0, i64 0), i32 14, i8* getelementptr inbounds ([15 x i8]* @.str123, i64 0, i64 0), i8* getelementptr inbounds ([8 x i8]* @.str2, i64 0, i64 0)) #9, !dbg !169
  unreachable, !dbg !169
...
define i32 @klee_int(i8* %name) #4 {
  ...
  %1 = bitcast i32* %x to i8*, !dbg !171
  call void @klee_make_symbolic(i8* %1, i64 4, i8* %name) #8, !dbg !171
  %2 = load i32* %x, align 4, !dbg !172, !tbaa !173
  ret i32 %2, !dbg !172
}

; Function Attrs: nounwind ssp uwtable
define void @klee_overshift_check(i64 %bitWidth, i64 %shift) #4 {
  %1 = icmp ult i64 %shift, %bitWidth, !dbg !175
  br i1 %1, label %3, label %2, !dbg !175

; <label>:2                                       ; preds = %0
  tail call void @klee_report_error(i8* getelementptr inbounds ([8 x i8]* @.str3, i64 0, i64 0), i32 0, i8* getelementptr inbounds ([16 x i8]* @.str14, i64 0, i64 0), i8* getelementptr inbounds ([14 x i8]* @.str25, i64 0, i64 0)) #9, !dbg !177
  unreachable, !dbg !177
...
define i32 @klee_range(i32 %start, i32 %end, i8* %name) #4 {
  %x = alloca i32, align 4
  %1 = icmp slt i32 %start, %end, !dbg !180
  br i1 %1, label %3, label %2, !dbg !180

; <label>:2                                       ; preds = %0
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) #9, !dbg !182
  unreachable, !dbg !182

; <label>:3                                       ; preds = %0
  %4 = add nsw i32 %start, 1, !dbg !183
  %5 = icmp eq i32 %4, %end, !dbg !183
  br i1 %5, label %21, label %6, !dbg !183

; <label>:6                                       ; preds = %3
  %7 = bitcast i32* %x to i8*, !dbg !185
  call void @klee_make_symbolic(i8* %7, i64 4, i8* %name) #8, !dbg !185
  %8 = icmp eq i32 %start, 0, !dbg !187
  %9 = load i32* %x, align 4, !dbg !189, !tbaa !173
  br i1 %8, label %10, label %13, !dbg !187

; <label>:10                                      ; preds = %6
  %11 = icmp ult i32 %9, %end, !dbg !189
  %12 = zext i1 %11 to i64, !dbg !189
  call void @klee_assume(i64 %12) #8, !dbg !189
  br label %19, !dbg !191

; <label>:13                                      ; preds = %6
  %14 = icmp sge i32 %9, %start, !dbg !192
  %15 = zext i1 %14 to i64, !dbg !192
  call void @klee_assume(i64 %15) #8, !dbg !192
  %16 = load i32* %x, align 4, !dbg !194, !tbaa !173
  %17 = icmp slt i32 %16, %end, !dbg !194
  %18 = zext i1 %17 to i64, !dbg !194
  call void @klee_assume(i64 %18) #8, !dbg !194
  br label %19

; <label>:19                                      ; preds = %13, %10
  %20 = load i32* %x, align 4, !dbg !195, !tbaa !173
  br label %21, !dbg !195
...
define weak i8* @memcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #4 {
  ...
  br i1 %1, label %._crit_edge, label %.lr.ph.preheader, !dbg !197
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %next.gep.sum279 = or i64 %index, 16, !dbg !198
  %4 = getelementptr i8* %srcaddr, i64 %next.gep.sum279, !dbg !198
  %5 = bitcast i8* %4 to <16 x i8>*, !dbg !198
  %wide.load200 = load <16 x i8>* %5, align 1, !dbg !198
  %6 = bitcast i8* %next.gep103 to <16 x i8>*, !dbg !198
  store <16 x i8> %wide.load, <16 x i8>* %6, align 1, !dbg !198
  %7 = getelementptr i8* %destaddr, i64 %next.gep.sum279, !dbg !198
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !198
  store <16 x i8> %wide.load200, <16 x i8>* %8, align 1, !dbg !198
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %12 = load i8* %src.03, align 1, !dbg !198, !tbaa !202
  %13 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !198
  store i8 %12, i8* %dest.02, align 1, !dbg !198, !tbaa !202
  %14 = icmp eq i64 %10, 0, !dbg !197
  br i1 %14, label %._crit_edge, label %.lr.ph, !dbg !197, !llvm.loop !203

._crit_edge:                                      ; preds = %.lr.ph, %middle.block, %0
  ret i8* %destaddr, !dbg !204
}

; Function Attrs: nounwind ssp uwtable
define weak i8* @memmove(i8* %dst, i8* %src, i64 %count) #4 {
  %1 = icmp eq i8* %src, %dst, !dbg !205
  br i1 %1, label %.loopexit, label %2, !dbg !205

; <label>:2                                       ; preds = %0
  %3 = icmp ugt i8* %src, %dst, !dbg !207
  br i1 %3, label %.preheader, label %18, !dbg !207

.preheader:                                       ; preds = %2
  %4 = icmp eq i64 %count, 0, !dbg !209
  br i1 %4, label %.loopexit, label %.lr.ph.preheader, !dbg !209
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %6 = bitcast i8* %next.gep to <16 x i8>*, !dbg !209
  %wide.load = load <16 x i8>* %6, align 1, !dbg !209
  %next.gep.sum586 = or i64 %index, 16, !dbg !209
  %7 = getelementptr i8* %src, i64 %next.gep.sum586, !dbg !209
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !209
  %wide.load207 = load <16 x i8>* %8, align 1, !dbg !209
  %9 = bitcast i8* %next.gep110 to <16 x i8>*, !dbg !209
  store <16 x i8> %wide.load, <16 x i8>* %9, align 1, !dbg !209
  %10 = getelementptr i8* %dst, i64 %next.gep.sum586, !dbg !209
  %11 = bitcast i8* %10 to <16 x i8>*, !dbg !209
  store <16 x i8> %wide.load207, <16 x i8>* %11, align 1, !dbg !209
  %index.next = add i64 %index, 32
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %13 = add i64 %.02, -1, !dbg !209
  %14 = getelementptr inbounds i8* %b.04, i64 1, !dbg !209
  %15 = load i8* %b.04, align 1, !dbg !209, !tbaa !202
  %16 = getelementptr inbounds i8* %a.03, i64 1, !dbg !209
  store i8 %15, i8* %a.03, align 1, !dbg !209, !tbaa !202
  %17 = icmp eq i64 %13, 0, !dbg !209
  br i1 %17, label %.loopexit, label %.lr.ph, !dbg !209, !llvm.loop !212

; <label>:18                                      ; preds = %2
  %19 = add i64 %count, -1, !dbg !213
  %20 = icmp eq i64 %count, 0, !dbg !215
  br i1 %20, label %.loopexit, label %.lr.ph9, !dbg !215

.lr.ph9:                                          ; preds = %18
  %21 = getelementptr inbounds i8* %src, i64 %19, !dbg !216
  %22 = getelementptr inbounds i8* %dst, i64 %19, !dbg !213
...
vector.body209:                                   ; preds = %vector.body209, %vector.memcheck224
  ...
  %next.gep236.sum = add i64 %.sum440, -15, !dbg !215
  %23 = getelementptr i8* %src, i64 %next.gep236.sum, !dbg !215
  %24 = bitcast i8* %23 to <16 x i8>*, !dbg !215
  %wide.load434 = load <16 x i8>* %24, align 1, !dbg !215
  %reverse = shufflevector <16 x i8> %wide.load434, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !215
  %.sum505 = add i64 %.sum440, -31, !dbg !215
  %25 = getelementptr i8* %src, i64 %.sum505, !dbg !215
  %26 = bitcast i8* %25 to <16 x i8>*, !dbg !215
  %wide.load435 = load <16 x i8>* %26, align 1, !dbg !215
  %reverse436 = shufflevector <16 x i8> %wide.load435, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !215
  %reverse437 = shufflevector <16 x i8> %reverse, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !215
  %27 = getelementptr i8* %dst, i64 %next.gep236.sum, !dbg !215
  %28 = bitcast i8* %27 to <16 x i8>*, !dbg !215
  store <16 x i8> %reverse437, <16 x i8>* %28, align 1, !dbg !215
  %reverse438 = shufflevector <16 x i8> %reverse436, <16 x i8> undef, <16 x i32> <i32 15, i32 14, i32 13, i32 12, i32 11, i32 10, i32 9, i32 8, i32 7, i32 6, i32 5, i32 4, i32 3, i32 2, i32 1, i32 0>, !dbg !215
  %29 = getelementptr i8* %dst, i64 %.sum505, !dbg !215
  %30 = bitcast i8* %29 to <16 x i8>*, !dbg !215
  store <16 x i8> %reverse438, <16 x i8>* %30, align 1, !dbg !215
  %index.next234 = add i64 %index212, 32
  %31 = icmp eq i64 %index.next234, %n.vec215
  br i1 %31, label %middle.block210, label %vector.body209, !llvm.loop !217
...
scalar.ph211:                                     ; preds = %scalar.ph211, %middle.block210
  ...
  %32 = add i64 %.16, -1, !dbg !215
  %33 = getelementptr inbounds i8* %b.18, i64 -1, !dbg !215
  %34 = load i8* %b.18, align 1, !dbg !215, !tbaa !202
  %35 = getelementptr inbounds i8* %a.17, i64 -1, !dbg !215
  store i8 %34, i8* %a.17, align 1, !dbg !215, !tbaa !202
  %36 = icmp eq i64 %32, 0, !dbg !215
  br i1 %36, label %.loopexit, label %scalar.ph211, !dbg !215, !llvm.loop !218
...
define weak i8* @mempcpy(i8* %destaddr, i8* %srcaddr, i64 %len) #4 {
  ...
  br i1 %1, label %15, label %.lr.ph.preheader, !dbg !220
...
vector.body:                                      ; preds = %vector.body, %vector.memcheck
  ...
  %next.gep.sum280 = or i64 %index, 16, !dbg !221
  %4 = getelementptr i8* %srcaddr, i64 %next.gep.sum280, !dbg !221
  %5 = bitcast i8* %4 to <16 x i8>*, !dbg !221
  %wide.load201 = load <16 x i8>* %5, align 1, !dbg !221
  %6 = bitcast i8* %next.gep104 to <16 x i8>*, !dbg !221
  store <16 x i8> %wide.load, <16 x i8>* %6, align 1, !dbg !221
  %7 = getelementptr i8* %destaddr, i64 %next.gep.sum280, !dbg !221
  %8 = bitcast i8* %7 to <16 x i8>*, !dbg !221
  store <16 x i8> %wide.load201, <16 x i8>* %8, align 1, !dbg !221
  %index.next = add i64 %index, 32
  %9 = icmp eq i64 %index.next, %n.vec
...
.lr.ph:                                           ; preds = %.lr.ph, %middle.block
  ...
  %12 = load i8* %src.03, align 1, !dbg !221, !tbaa !202
  %13 = getelementptr inbounds i8* %dest.02, i64 1, !dbg !221
  store i8 %12, i8* %dest.02, align 1, !dbg !221, !tbaa !202
  %14 = icmp eq i64 %10, 0, !dbg !220
  br i1 %14, label %._crit_edge, label %.lr.ph, !dbg !220, !llvm.loop !223
...
; <label>:15                                      ; preds = %._crit_edge, %0
  ...
  ret i8* %dest.0.lcssa, !dbg !224
}

; Function Attrs: nounwind ssp uwtable
define weak i8* @memset(i8* %dst, i32 %s, i64 %count) #4 {
  %1 = icmp eq i64 %count, 0, !dbg !225
  br i1 %1, label %._crit_edge, label %.lr.ph, !dbg !225

.lr.ph:                                           ; preds = %0
  %2 = trunc i32 %s to i8, !dbg !226
  br label %3, !dbg !225

; <label>:3                                       ; preds = %3, %.lr.ph
  %a.02 = phi i8* [ %dst, %.lr.ph ], [ %5, %3 ]
  %.01 = phi i64 [ %count, %.lr.ph ], [ %4, %3 ]
  %4 = add i64 %.01, -1, !dbg !225
  %5 = getelementptr inbounds i8* %a.02, i64 1, !dbg !226
  store volatile i8 %2, i8* %a.02, align 1, !dbg !226, !tbaa !202
  %6 = icmp eq i64 %4, 0, !dbg !225
  br i1 %6, label %._crit_edge, label %3, !dbg !225
...
!158 = metadata !{i32 14, i32 0, metadata !20, null}
!159 = metadata !{i32 17, i32 0, metadata !160, null}
!160 = metadata !{i32 786443, metadata !21, metadata !20, i32 17, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/ubuntu/klee/runtime/Intrinsic/klee_choose.c]
!161 = metadata !{metadata !162, metadata !162, i64 0}
!162 = metadata !{metadata !"long", metadata !163, i64 0}
!163 = metadata !{metadata !"omnipotent char", metadata !164, i64 0}
!164 = metadata !{metadata !"Simple C/C++ TBAA"}
!165 = metadata !{i32 18, i32 0, metadata !160, null}
!166 = metadata !{i32 19, i32 0, metadata !20, null}
!167 = metadata !{i32 13, i32 0, metadata !168, null}
!168 = metadata !{i32 786443, metadata !34, metadata !33, i32 13, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/ubuntu/klee/runtime/Intrinsic/klee_div_zero_check.c]
!169 = metadata !{i32 14, i32 0, metadata !168, null}
!170 = metadata !{i32 15, i32 0, metadata !33, null}
!171 = metadata !{i32 15, i32 0, metadata !44, null}
!172 = metadata !{i32 16, i32 0, metadata !44, null}
!173 = metadata !{metadata !174, metadata !174, i64 0}
!174 = metadata !{metadata !"int", metadata !163, i64 0}
!175 = metadata !{i32 21, i32 0, metadata !176, null}
!176 = metadata !{i32 786443, metadata !59, metadata !58, i32 21, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/ubuntu/klee/runtime/Intrinsic/klee_overshift_check.c]
!177 = metadata !{i32 27, i32 0, metadata !178, null}
!178 = metadata !{i32 786443, metadata !59, metadata !176, i32 21, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/ubuntu/klee/runtime/Intrinsic/klee_overshift_check.c]
!179 = metadata !{i32 29, i32 0, metadata !58, null}
!180 = metadata !{i32 16, i32 0, metadata !181, null}
!181 = metadata !{i32 786443, metadata !71, metadata !70, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/ubuntu/klee/runtime/Intrinsic/klee_range.c]
!182 = metadata !{i32 17, i32 0, metadata !181, null}
!183 = metadata !{i32 19, i32 0, metadata !184, null}
!184 = metadata !{i32 786443, metadata !71, metadata !70, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/ubuntu/klee/runtime/Intrinsic/klee_range.c]
!185 = metadata !{i32 22, i32 0, metadata !186, null}
!186 = metadata !{i32 786443, metadata !71, metadata !184, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/ubuntu/klee/runtime/Intrinsic/klee_range.c]
!187 = metadata !{i32 25, i32 0, metadata !188, null}
!188 = metadata !{i32 786443, metadata !71, metadata !186, i32 25, i32 0, i32 4} ; [ DW_TAG_lexical_block ] [/home/ubuntu/klee/runtime/Intrinsic/klee_range.c]
!189 = metadata !{i32 26, i32 0, metadata !190, null}
!190 = metadata !{i32 786443, metadata !71, metadata !188, i32 25, i32 0, i32 5} ; [ DW_TAG_lexical_block ] [/home/ubuntu/klee/runtime/Intrinsic/klee_range.c]
!191 = metadata !{i32 27, i32 0, metadata !190, null}
!192 = metadata !{i32 28, i32 0, metadata !193, null}
!193 = metadata !{i32 786443, metadata !71, metadata !188, i32 27, i32 0, i32 6} ; [ DW_TAG_lexical_block ] [/home/ubuntu/klee/runtime/Intrinsic/klee_range.c]
!194 = metadata !{i32 29, i32 0, metadata !193, null}
!195 = metadata !{i32 32, i32 0, metadata !186, null}
!196 = metadata !{i32 34, i32 0, metadata !70, null}
!197 = metadata !{i32 16, i32 0, metadata !83, null}
!198 = metadata !{i32 17, i32 0, metadata !83, null}
!199 = metadata !{metadata !199, metadata !200, metadata !201}
!200 = metadata !{metadata !"llvm.vectorizer.width", i32 1}
!201 = metadata !{metadata !"llvm.vectorizer.unroll", i32 1}
!202 = metadata !{metadata !163, metadata !163, i64 0}
!203 = metadata !{metadata !203, metadata !200, metadata !201}
!204 = metadata !{i32 18, i32 0, metadata !83, null}
!205 = metadata !{i32 16, i32 0, metadata !206, null}
!206 = metadata !{i32 786443, metadata !103, metadata !102, i32 16, i32 0, i32 0} ; [ DW_TAG_lexical_block ] [/home/ubuntu/klee/runtime/Intrinsic/memmove.c]
!207 = metadata !{i32 19, i32 0, metadata !208, null}
!208 = metadata !{i32 786443, metadata !103, metadata !102, i32 19, i32 0, i32 1} ; [ DW_TAG_lexical_block ] [/home/ubuntu/klee/runtime/Intrinsic/memmove.c]
!209 = metadata !{i32 20, i32 0, metadata !210, null}
!210 = metadata !{i32 786443, metadata !103, metadata !208, i32 19, i32 0, i32 2} ; [ DW_TAG_lexical_block ] [/home/ubuntu/klee/runtime/Intrinsic/memmove.c]
!211 = metadata !{metadata !211, metadata !200, metadata !201}
!212 = metadata !{metadata !212, metadata !200, metadata !201}
!213 = metadata !{i32 22, i32 0, metadata !214, null}
!214 = metadata !{i32 786443, metadata !103, metadata !208, i32 21, i32 0, i32 3} ; [ DW_TAG_lexical_block ] [/home/ubuntu/klee/runtime/Intrinsic/memmove.c]
!215 = metadata !{i32 24, i32 0, metadata !214, null}
!216 = metadata !{i32 23, i32 0, metadata !214, null}
!217 = metadata !{metadata !217, metadata !200, metadata !201}
!218 = metadata !{metadata !218, metadata !200, metadata !201}
!219 = metadata !{i32 28, i32 0, metadata !102, null}
!220 = metadata !{i32 15, i32 0, metadata !117, null}
!221 = metadata !{i32 16, i32 0, metadata !117, null}
!222 = metadata !{metadata !222, metadata !200, metadata !201}
!223 = metadata !{metadata !223, metadata !200, metadata !201}
!224 = metadata !{i32 17, i32 0, metadata !117, null}
!225 = metadata !{i32 13, i32 0, metadata !132, null}
!226 = metadata !{i32 14, i32 0, metadata !132, null}
!227 = metadata !{i32 15, i32 0, metadata !132, null}
